      ...
      <section className="pt-24 sm:pt-28 pb-8 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-500/10 border border-indigo-500/20 mb-6">
            ...
            <span className="text-xs font-mono text-indigo-400">Real-time ASL Recognition</span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            >
              ...
              <p className="text-xs text-zinc-600">
                {lang === 'en' ? 'View source code and implementation' : 'Voir le code source et l\'implementation'}
              </p>
            </a>
            ...
            >
              ...
              <p className="text-xs text-zinc-600">
                {lang === 'en' ? 'Connect professionally' : 'Connexion professionnelle'}
              </p>
            </a>
